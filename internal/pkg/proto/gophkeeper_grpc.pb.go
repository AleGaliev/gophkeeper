...
type GophKeeperClient interface {
	...
	ListSecrets(ctx context.Context, in *GetListSecretsRequest, opts ...grpc.CallOption) (*GetListSecretsResponse, error)
...
func (c *gophKeeperClient) Register(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (c *gophKeeperClient) ListSecrets(ctx context.Context, in *GetListSecretsRequest, opts ...grpc.CallOption) (*GetListSecretsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetListSecretsResponse)
...
type GophKeeperServer interface {
	...
	// ListSecrets retrieves all secrets for the authenticated user.
	ListSecrets(context.Context, *GetListSecretsRequest) (*GetListSecretsResponse, error)
	// UpdateSecret updates an existing secret.
...
func (UnimplementedGophKeeperServer) Register(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func (UnimplementedGophKeeperServer) ListSecrets(context.Context, *GetListSecretsRequest) (*GetListSecretsResponse, error) {
...
func _GophKeeper_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GophKeeperServer).Register(ctx, req.(*LoginRequest))
	}
...
func _GophKeeper_ListSecrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GophKeeperServer).ListSecrets(ctx, req.(*GetListSecretsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
